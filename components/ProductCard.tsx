...
const ProductCard: React.FC<IProduct> = ({ id, img, name, price, sale, category }) => {
  ...
  return (
    <div className="cursor-pointer group" onClick={() => router.push(`/details/${id}`)}>
      <div className="relative">
        <Image className="w-full" src={img} width={1000} height={1142} alt={name} />

        {sale && (
          <div className="bg-red-600 inline-block absolute top-0 left-0 text-[14px] text-white rounded-md px-2 px-[2px] m-4">
            SALE!
          </div>
        )}
